...
# --- CSS ULTRA-SIMPLIFICADO para resolver o TypeError na inicialização ---
# Focando apenas no alinhamento do texto
st.markdown("""
<style>
/* Alinha o texto dentro do st.text_area para a esquerda (Essencial para a cópia) */
textarea {
